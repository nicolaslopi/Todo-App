    ...
    <div class="container pt-2" style="width: 500px;">
        <form @submit.prevent="onSubmit">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="email" v-model="email" v-bind="nameAttrs"/>
            ...
            <div class="text-center">
                <button type="submit" class="btn mt-4 text-white fs-5" style="width: 50%;">Iniciar sesión</button>
            </div>
        </form>
    </div>
</template>
...
const [email, nameAttrs] = defineField('email')
